...
abstract class FlowConvertor
{
  public function getTriggers()
  {
    return  [
      ...
      28 => ['description' => clienttranslate('When a card leaves your Reserve during the Afternoon —'), 'trigger' => ['ChooseAssignment', 'Discard'], 'conditions' => ['isAfternoon', 'isFromReserve']],
