...
class OD_Rare_ResentfulRobin extends \ALT\Models\Card
{
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'costReserve' => 1,
      'changedStats' => ['forest'],
      'effectPlayed' => FT::ACTION(CHECK_CONDITION, ['condition' => 'isOpponentExpeditionNotEmpty', 'effect' => FT::GAIN(ME, BOOST)]),
      'effectReserve' => FT::ACTION(SPECIAL_EFFECT, ['effect' => 'ascend', 'expedition' => 'source'])
    ];
  }
}
