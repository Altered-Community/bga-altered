...
class OD_Rare_EbenezerScrooge extends \ALT\Models\Card
{
    public function __construct($row)
    {
        parent::__construct($row);
        $this->properties = [
            'uid' => 'ALT_ALIZE_B_OR_37_R1',
            ...
            'extension' => 'TBF',
            'subtypes'  => [BUREAUCRAT],
            'effectDesc' => clienttranslate('#Cards played from Reserve cost {1} more.#'),
