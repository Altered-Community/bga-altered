...
class BR_Rare_Siren extends \ALT\Models\Card
{
  public function __construct($row)
  {
    parent::__construct($row);
    $this->properties = [
      'uid' => 'ALT_FUGUE_B_YZ_140_R2',
      ...
      'extension' => 'NEJ',
      'subtypes' => [FAIRY],
      'effectDesc' => clienttranslate('{R} Target non-Anchored Character #with Base Cost {3} or less# defects.'),
      'forest' => 1,
      'mountain' => 1,
      'ocean' => 2,
      'costHand' => 5,
