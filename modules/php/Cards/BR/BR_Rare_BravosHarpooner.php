...
class BR_Rare_BravosHarpooner extends \ALT\Models\Card
{
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'extension' => 'SO',
      'subtypes'  => [ADVENTURER],
      'effectDesc' => clienttranslate('#{J}# You may <RUSH> to <SABOTAGE_INF>. (Rush means playing another card immediately. If you do, discard up to one target card from a Reserve.)'),
      'forest' => 3,
      'mountain' => 2,
      'ocean' => 2,
      'costHand' => 3,
