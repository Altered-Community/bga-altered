...
class BR_Rare_StigmaofCowardice extends \ALT\Models\Card
{
  public function __construct($row){
		parent::__construct($row);
    $this->properties = [
      'uid' => 'ALT_EOLE_B_BR_114_R1',
      ...
      'tough'=>1,
      'effectPlayed' => FT::ACTION(END_AFTERNOON, []),
      'effectPassive' => [
        'EndTurn' => [
          'conditions' => ['isNotMe'],
          'output' => FT::ACTION(CHOOSE_ASSIGNMENT, ['actions' => ['play'], 'types' => [CHARACTER, SPELL, PERMANENT]], ['optional' => true]),
        ]
      ]
    ];
  }
