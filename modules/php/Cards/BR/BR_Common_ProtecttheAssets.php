...
class BR_Common_ProtecttheAssets extends \ALT\Models\Card
{
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'supportDesc' => clienttranslate('<COMPLETED_LOW>: Characters in your Reserve are <TOUGH_CHA_P_1>. (Opponents must pay {1} to target them.)'),
      'costHand' => 1,
      'costReserve' => 1,
      ...
      'effectCompleted' => [
        // Completed support: reserve characters gain protection from targeting.
