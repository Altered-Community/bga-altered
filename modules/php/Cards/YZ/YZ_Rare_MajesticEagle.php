...
class YZ_Rare_MajesticEagle extends \ALT\Models\Card
{
  public function __construct($row)
  {
    parent::__construct($row);
    $this->properties = [
      'uid' => 'ALT_FUGUE_B_OR_131_R2',
      ...
      'effectDesc' => clienttranslate('#When I go to your Reserve from your Expeditions — Create an Ordis Recruit 1/1/1 Soldier token in my Expedition.#'),
      'forest' => 1,
      'mountain' => 1,
      'ocean' => 0,
      'costHand' => 1,
