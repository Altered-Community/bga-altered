...
class YZ_Rare_CassandraCursedProphetess extends \ALT\Models\Card
{
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'type' => CHARACTER,
      'subtypes' => [MAGE],
      'effectDesc' => clienttranslate('{R} You may reveal a Spell with Hand Cost {4} or more from your hand. If you don\'t, I gain Fleeting. #If the Hand Cost is {7} or more, draw a card.#'),
      'forest' => 2,
      'mountain' => 2,
      'ocean' => 3,
      'costHand' => 2,
