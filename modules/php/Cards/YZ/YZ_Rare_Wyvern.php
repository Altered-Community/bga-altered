...
class YZ_Rare_Wyvern extends \ALT\Models\Card
{
  public function __construct($row)
  {
    parent::__construct($row);
    $this->properties = [
      'uid' => 'ALT_CYCLONE_B_MU_73_R2',
      ...
      'costHand' => 4,
      'costReserve' => 3,
      'effectHand' => FT::ACTION(TARGET, ['maxHandCost' => 1, 'upTo' => true, 'n' => 2, 'effect' => FT::DISCARD_TO_RESERVE()]),
    ];
  }
}
