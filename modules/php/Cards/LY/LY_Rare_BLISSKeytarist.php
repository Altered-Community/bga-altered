...
class LY_Rare_BLISSKeytarist extends \ALT\Models\Card
{
    public function __construct($row)
    {
        parent::__construct($row);
        $this->properties = [
            'uid' => 'ALT_BISE_B_LY_52_R1',
            ...
            'extension' => 'WFTM',
            'subtypes'  => [ARTIST],
            'effectDesc' => clienttranslate('At Dusk — If I\'m <BOOSTED>, reveal the top card of your deck. If it\'s an #Artist# or #Song#, draw it. Otherwise, discard it.'),
            ...
            'effectPassive' => [
                'BeforeDusk' => [
                    'conditions' => ['isMe'],
                    'output' => FT::ACTION(SPECIAL_EFFECT, ['effect' => 'boostedRevealArtistSong'])
                ]
            ]
        ];
    }
