  ...
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'effectDesc' => clienttranslate(
        'Target Character with Base Cost {3} or less switches Expeditions, then gains <ANCHORED>. (Switch means joining the other Expedition of its controller.)'
      ),
      'costHand' => 3,
      'costReserve' => 2,
