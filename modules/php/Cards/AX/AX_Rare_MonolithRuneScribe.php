...
class AX_Rare_MonolithRuneScribe extends \ALT\Models\Card
{
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'faction' => FACTION_AX,
      'rarity' => RARITY_RARE,
      'name' => 'Monolith Rune-Scribe',
      'typeline' => 'Character - Scholar',
      'type' => CHARACTER,
      'flavorText' => 'The Ordis manifest their Alteration through the use of glyphs of power.',
      'artist' => 'HuoMiao Studio',
      'subtypes' => [SCHOLAR],
      'effectDesc' => '#{H} If you control a token, $<RESUPPLY_LOW>.#',
      'forest' => 1,
      'mountain' => 2,
      'ocean' => 2,
      'costHand' => 2,
