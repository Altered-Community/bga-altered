  ...
  public function __construct($row)
  {
    ...
    $this->properties = [
      ...
      'effectDesc' => clienttranslate(
        'Characters you control have [Tough 2].  At Noon — Target Character you control gains 1 boost. (Your opponent\'s Spells and abilities that target me cost {2} more.)'
      ),
      'costHand' => 3,
      'costReserve' => 3,
    ];
