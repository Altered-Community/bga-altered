       ...
       $('altered-overlay-content').innerHTML = `
         ...
         <div id='deck-wizard' class='deck-wizard-step-2 account-not-configured-screen'>
           <div id='account-not-configured-desc'>
             ...
             <p>${_('You can create an account, build or import your decks on any ')} <a class="account-not-configured-link" href="Use this link : https://altered.re/pages/news-detail?slug=get-ready-to-continue-your-altered-adventure-on-board-game-arena" target="_blank" rel="noopener noreferrer">acknowledged deckbuilders</a></p>
